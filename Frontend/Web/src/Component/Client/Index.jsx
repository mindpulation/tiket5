...
import Genqr from '../Modal/Genqr';

export default function Index(){            

    // const endpoint = "http://88.99.38.173:2020/";        
    const endpoint = "https://138.201.173.65:2021/";        
    ...
    const [,setModalVis] = useContext(ModalState);
    ...
    return(
        <div className="Parent">
            <Genqr nama={tempNama} cd={tempCode}></Genqr>
                            ...
                            <div className="group">
                                ...
                                <div className="group-print" id="group-print">
                                    <div className="txt-data">
                                        <span><b>Selamat Datang</b> di Edu Expo 2020 MGMP BK SMA KOTA BEKASI</span>
                                    </div>
                                    <div className="txt-data">
